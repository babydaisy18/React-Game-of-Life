...
var Cell = function (_React$Component) {
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      if (this.props.alive) {
        return _react2.default.createElement('span', { className: 'cell-component cell alive', onClick: function onClick() {
            return _this2.onCellClick();
          } });
      } else {
        return _react2.default.createElement('span', { className: 'cell-component cell', onClick: function onClick() {
            return _this2.onCellClick();
          } });
      }
    }
